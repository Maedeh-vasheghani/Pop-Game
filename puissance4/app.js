...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const winsound = new Audio ("victory-sound-effect.mp3")
    let currentPlayer = 1
    ...
    (function(index){
        ...
        squares[i].onclick = function(){
            ...
            if(squares[index + 7].classList.contains('taken')){
                        ...
                        if (currentPlayer === 1 ){
                            if (squares[index].classList.contains('player-two')|| squares[index].classList.contains('player-one')){
                                alert('tu veux tricher ????')
                            }else{
                            ...
                            displaycurrentPlayer.innerHTML = currentPlayer
                             ...
                             //check si un joueur essaye de placer son point a un endroit ou il y en a deja un
                        ...
                        }else alert('tu peux pas')
                    }
    })(i)

    //victoire checker
    // toutes les combinaisons possible pour que l'un des deux joueurs gagne
    function checkBoard() {
    const winningArrays = [
    ...
    for(let y = 0; y < winningArrays.length; y++){
        ...
        result.innerHTML = 'Le joueur 1 a gagné'
        alert('Bien joué BG')
        winsound.play()  
        } 
        ...
        result.innerHTML = 'Le joueur 2 a gagné'
        winsound.play()
        alert('Bien joué BG') 
        }
    }
